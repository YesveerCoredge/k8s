...
sudo apt-get update
sudo apt-get install -y kubelet=1.28.3-1.1 kubeadm=1.28.3-1.1 kubectl=1.28.3-1.1
# Prevent them from being updated automatically
sudo apt-mark hold kubelet=1.28.3-1.1 kubeadm=1.28.3-1.1 kubectl=1.28.3-1.1
}
 
